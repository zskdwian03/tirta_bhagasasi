...
// ===== Render PDF ke Canvas (auto-resize mengikuti template flipbook) =====
async function renderPageTo(container, page) {
  // Ambil ukuran kontainer flipbook
  ...
  // Terapkan ukuran agar pas di template flipbook
  canvas.style.width = `${scaledViewport.width}px`;
  canvas.style.height = `${scaledViewport.height}px`;
  textLayerDiv.style.width = `${scaledViewport.width}px`;
  textLayerDiv.style.height = `${scaledViewport.height}px`;

  // Pusatkan agar rapi dalam setiap sisi kertas
  container.style.display = "flex";
  container.style.alignItems = "center";
  container.style.justifyContent = "center";
  container.style.overflow = "hidden";

  // Kosongkan kontainer dan tambahkan elemen baru
  container.innerHTML = "";
